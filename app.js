...
// ✅ Planning web : VERT=effectué, BLEU=planifié, ROUGE=en retard
// ✅ Excel : mêmes couleurs + structure propre + Décembre correct
// ✅ Excel styles via xlsx-js-style (fgColor rgb sans #)
...
function defaultTasks(){
  const T=2;
  return[
    {id:1, comp:'FFG 924',crit:1,type:'Huile',  prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-15',loc:'Atelier FFG',      dur:'45 min',note:'Vidange boîte de vitesses principale.',done:false,hist:[]},
    {id:2, comp:'FFG 924',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-05',loc:'Atelier FFG',      dur:'20 min',note:'Graissage roulements arbres impression.',done:false,hist:[]},
    ...
    {id:4, comp:'FFG 924',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-15',loc:'Atelier FFG',      dur:'20 min',note:'Graissage chaînes transmission.',done:false,hist:[]},
    {id:5, comp:'DRO HQP',crit:1,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-01',loc:'Zone DRO',         dur:'1h',    note:'Vidange huile hydraulique.',done:false,hist:[]},
    {id:6, comp:'DRO HQP',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-20',loc:'Zone DRO',         dur:'25 min',note:'Graissage roulements rouleaux.',done:false,hist:[]},
    {id:7, comp:'DRO HQP',crit:2,type:'Huile',  prod:'',qty:'',freq:'Semestrielle', techId:T,date:'2026-03-01',loc:'Zone DRO',         dur:'45 min',note:'Vidange réducteur entraînement.',done:false,hist:[]},
    {id:8, comp:'DRO 1',  crit:1,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-10',loc:'Zone DRO',         dur:'1h',    note:'Vidange huile hydraulique centrale.',done:false,hist:[]},
    {id:9, comp:'DRO 1',  crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-25',loc:'Zone DRO',         dur:'20 min',note:'Graissage roulements cylindres.',done:false,hist:[]},
    {id:10,comp:'DRO 1',  crit:3,type:'Graisse',prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-10',loc:'Zone DRO',         dur:'20 min',note:'Graissage guidages linéaires.',done:false,hist:[]},
    {id:11,comp:'ONDULEUSE',crit:1,type:'Huile',  prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-10',loc:'Salle onduleuse',dur:'1h30',  note:'Vidange huile réducteurs rouleaux.',done:false,hist:[]},
    {id:12,comp:'ONDULEUSE',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-05',loc:'Salle onduleuse',dur:'30 min',note:'Graissage roulements rouleaux.',done:false,hist:[]},
    {id:13,comp:'ONDULEUSE',crit:1,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-03-01',loc:'Salle onduleuse',dur:'1h',    note:'Vidange boîte vitesses.',done:false,hist:[]},
    {id:14,comp:'ONDULEUSE',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-10',loc:'Salle onduleuse',dur:'30 min',note:'Graissage chaînes et pignons.',done:false,hist:[]},
    ...
    {id:17,comp:'MARTIN 1224',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-06',loc:'Atelier Martin',dur:'25 min',note:'Graissage roulements arbres impression.',done:false,hist:[]},
    {id:18,comp:'MARTIN 1224',crit:2,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-03-15',loc:'Atelier Martin',dur:'45 min',note:'Vidange réducteur section découpe.',done:false,hist:[]},
    {id:19,comp:'MARTIN 1224',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-20',loc:'Atelier Martin',dur:'25 min',note:'Graissage chaînes et pignons.',done:false,hist:[]},
    {id:20,comp:'MARTIN 1224',crit:3,type:'Graisse',prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-20',loc:'Atelier Martin',dur:'20 min',note:'Graissage guidages barres.',done:false,hist:[]},
    {id:21,comp:'MARTIN 924',crit:1,type:'Huile',  prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-22',loc:'Atelier Martin',dur:'50 min',note:'Vidange huile boîte principale.',done:false,hist:[]},
    {id:22,comp:'MARTIN 924',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-06',loc:'Atelier Martin',dur:'20 min',note:'Graissage roulements arbres.',done:false,hist:[]},
    ...
    {id:26,comp:'1224 IMPRIMANTE',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-05',loc:'Zone impression',dur:'20 min',note:'Graissage roulements cylindres.',done:false,hist:[]},
    ...
    {id:30,comp:'KLETT',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-12',loc:'Zone collage',   dur:'20 min',note:'Graissage roulements encolleuse.',done:false,hist:[]},
    ...
    {id:32,comp:'MINILINE',crit:2,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-15',loc:'Ligne mini',    dur:'30 min',note:'Vidange réducteur entraînement.',done:false,hist:[]},
    {id:33,comp:'MINILINE',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-15',loc:'Ligne mini',    dur:'15 min',note:'Graissage roulements convoyeur.',done:false,hist:[]},
    {id:34,comp:'MINILINE',crit:3,type:'Graisse',prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-15',loc:'Ligne mini',    dur:'15 min',note:'Graissage chaînes guidages.',done:false,hist:[]},
    ...
    {id:36,comp:'LANGSTONE',crit:1,type:'Graisse',prod:'',qty:'',freq:'Hebdomadaire', techId:T,date:'2026-01-05',loc:'Atelier Langstone',dur:'25 min',note:'Graissage roulements rouleaux.',done:false,hist:[]},
    ...
    {id:39,comp:'BOBST LILA',crit:1,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-03-01',loc:'Zone Bobst',    dur:'1h30',  note:'Vidange huile centrale lubrification.',done:false,hist:[]},
    ...
    {id:41,comp:'BOBST LILA',crit:2,type:'Huile',  prod:'',qty:'',freq:'Semestrielle', techId:T,date:'2026-06-01',loc:'Zone Bobst',    dur:'1h',    note:'Vidange réducteur principal.',done:false,hist:[]},
    {id:42,comp:'BOBST LILA',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-08',loc:'Zone Bobst',    dur:'20 min',note:'Graissage guidages colonnes.',done:false,hist:[]},
    {id:43,comp:'BOBST LILA',crit:3,type:'Graisse',prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-03-01',loc:'Zone Bobst',    dur:'20 min',note:'Graissage chaînes convoyeur.',done:false,hist:[]},
    ...
    {id:45,comp:'PICEUSE GAZELLA',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-20',loc:'Zone piquage', dur:'20 min',note:'Graissage roulements arbres.',done:false,hist:[]},
    {id:46,comp:'PICEUSE GAZELLA',crit:3,type:'Graisse',prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-02-20',loc:'Zone piquage', dur:'15 min',note:'Graissage chaînes convoyeur.',done:false,hist:[]},
    {id:47,comp:'BOBST VISION',crit:1,type:'Huile',  prod:'',qty:'',freq:'Trimestrielle',techId:T,date:'2026-03-10',loc:'Zone Bobst',    dur:'1h30',  note:'Vidange huile centrale lubrification.',done:false,hist:[]},
    {id:48,comp:'BOBST VISION',crit:1,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-10',loc:'Zone Bobst',    dur:'30 min',note:'Graissage roulements platine.',done:false,hist:[]},
    ...
    {id:50,comp:'BOBST VISION',crit:2,type:'Graisse',prod:'',qty:'',freq:'Mensuelle',    techId:T,date:'2026-01-10',loc:'Zone Bobst',    dur:'25 min',note:'Graissage guidages colonnes.',done:false,hist:[]},
...
// ── SAUVEGARDE ──
function loadData(){
  try{const su=localStorage.getItem(LS_USERS),st=localStorage.getItem(LS_TASKS);
    users=su?JSON.parse(su):defaultUsers();tasks=st?JSON.parse(st):defaultTasks();
...
// ── AUTH ──
function doLogin(){
  const loginVal=document.getElementById('loginUser').value.trim(),pwd=document.getElementById('loginPwd').value;
  ...
  if(!u||u.pwd!==pwd){errEl.textContent='❌ Identifiant ou mot de passe incorrect.';document.getElementById('loginPwd').value='';document.getElementById('loginPwd').focus();return;}
  currentUser=u;
...
function doLogout(){
  currentUser=null;filterState={fltCrit:'',fltType:'',fltTech:'',fltStat:'',fltMach:'',srch:''};
  document.getElementById('app').style.display='none';document.getElementById('loginScreen').style.display='flex';
  document.getElementById('loginUser').value='';document.getElementById('loginPwd').value='';document.getElementById('loginErr').textContent='';
}
...
// ── FIX RECHERCHE : DOM partiel ──
function onFilterChange(){
  syncFilterState();
  if(currentView==='liste'&&document.getElementById('listTbody'))updateListPartial();
...
function updateListPartial(){
  ...
  const tbody=document.getElementById('listTbody');if(tbody)tbody.innerHTML=buildTableRows(all,af);
  const se=document.getElementById('filterSummary');if(se)se.innerHTML=buildFilterSummary();
  const rb=document.getElementById('filterResetBtn');if(rb)rb.style.display=af>0?'':'none';
}
...
function getFiltered(){
  ...
  return list.filter(t=>{
    const s=getStatus(t);
    if(fm&&t.loc!==fm)return false;if(fc&&String(t.crit)!==String(fc))return false;if(ft&&t.type!==ft)return false;if(fth&&String(t.techId)!==String(fth))return false;if(fs&&s!==fs)return false;
    if(q){const sf=[t.comp,t.prod,t.loc,t.note,t.freq,t.qty,t.type,getTechName(t.techId),cLabel(t.crit),sLabel(getStatus(t)),fmtD(t.date)].map(x=>(x||'').toLowerCase());if(!sf.some(f=>f.includes(q)))return false;}
    return true;
  }).sort((a,b)=>{
    let va=a[sortCol],vb=b[sortCol];
    if(['crit','id'].includes(sortCol)){va=+va;vb=+vb;}if(sortCol==='date'){va=new Date(va);vb=new Date(vb);}
...
function buildListView(){
  ...
  const ctrlHTML=`<div class="ctrl-bar">
    <div class="search-wrap"><span class="search-icon">🔍</span><input type="text" id="srch" placeholder="Rechercher composant, type, technicien…" value="${esc(filterState.srch)}" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" oninput="onFilterChange()" onkeydown="event.stopPropagation()"/></div>
    ${machineFilter}
...
function buildMonthWeekMap(yr){
  const map={};
  for(let w=1;w<=52;w++){
    const simple=new Date(yr,0,1+(w-1)*7);const dow=simple.getDay()||7;
    const mon=new Date(simple);mon.setDate(simple.getDate()-dow+1);
...
function buildCalView(){
  ...
  const header=`<div class="cal-header">
    <div class="year-nav"><button onclick="calYear--;render()">◀ Précédent</button><span class="year-label">${calYear}</span><button onclick="calYear++;render()">Suivant ▶</button></div>
    <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">${machSelect}${dlBtn}</div>
    <div class="cal-legend">
      <span><span class="leg-sq" style="background:#22C55E;border:1px solid #15803D"></span><strong>Effectué</strong></span>
      <span><span class="leg-sq" style="background:#3B82F6;border:1px solid #1D4ED8"></span><strong>Planifié</strong></span>
      <span><span class="leg-sq" style="background:#EF4444;border:1px solid #B91C1C"></span><strong>En retard</strong></span>
      <span><span class="leg-sq" style="background:#F59E0B;border:1px solid #B45309"></span><strong>Bientôt (≤7j)</strong></span>
    </div>
  </div>`;
  ...
  const weekHeaderCells=weeks.map(w=>{const isCur=w===currentWeek&&calYear===now.getFullYear();return`<th style="background:${isCur?'#EF4444':'#2d4a7a'};color:#fff;text-align:center;font-size:10px;font-weight:600;border:1px solid #1a365d;min-width:22px;width:22px;padding:3px 1px">S${w}</th>`;}).join('');
  let rowsHTML='';
...
function calClick(si){
  const t=tasks[si],canCheck=isAdmin()||t.techId===currentUser.id;
  if(!canCheck){toast('Vous ne pouvez cocher que vos propres tâches','err');return;}
  showCf('Confirmer intervention',`Marquer <strong>${esc(t.comp)}</strong> comme effectué ?`,()=>{tasks[si].done=true;tasks[si].hist.push(today());saveTasks();toast('Tâche marquée effectuée');render();});
}

// ══════════════════════════════════════════════════════════
// EXCEL — couleurs vert/bleu/rouge identiques au planning web
// IMPORTANT : utilise xlsx-js-style (pas xlsx standard)
// La bibliothèque doit être chargée dans index.html :
//   <script src="https://cdn.jsdelivr.net/npm/xlsx-js-style@1.2.0/dist/xlsx.bundle.js"></script>
// ══════════════════════════════════════════════════════════

// Détecte si la lib supporte les styles
function xlsxLib(){return typeof XLSXStyle!=='undefined'?XLSXStyle:(typeof XLSX!=='undefined'?XLSX:null);}

// Styles de base
function S(bg,fg,bold,sz,halign,borderRight){
  const t={style:'thin',color:{rgb:'D1D5DB'}};
  const r=borderRight?{style:'medium',color:{rgb:'374151'}}:t;
  return{fill:{patternType:'solid',fgColor:{rgb:bg}},font:{bold:!!bold,color:{rgb:fg||'374151'},sz:sz||9,name:'Calibri'},alignment:{horizontal:halign||'left',vertical:'center',wrapText:false},border:{top:t,bottom:t,left:t,right:r}};
}
function SH(bg,fg,sz){ // header style
  const t={style:'thin',color:{rgb:'2D5282'}};
  return{fill:{patternType:'solid',fgColor:{rgb:bg||'1E3A5F'}},font:{bold:true,color:{rgb:fg||'FFFFFF'},sz:sz||10,name:'Calibri'},alignment:{horizontal:'center',vertical:'center',wrapText:false},border:{top:{style:'medium',color:{rgb:'0F2340'}},bottom:{style:'medium',color:{rgb:'0F2340'}},left:t,right:t}};
}

// Applique style en-tête + lignes données sur un sheet simple
function styleSimpleSheet(ws,colCount,rowCount){
  for(let ci=0;ci<colCount;ci++){const ref=XLSX.utils.encode_cell({r:0,c:ci});if(!ws[ref])ws[ref]={t:'s',v:''};ws[ref].s=SH();}
  for(let ri=0;ri<rowCount;ri++){
    const bg=ri%2===0?'FFFFFF':'F8FAFC';
    for(let ci=0;ci<colCount;ci++){const ref=XLSX.utils.encode_cell({r:ri+1,c:ci});if(!ws[ref])ws[ref]={t:'s',v:''};ws[ref].s=S(bg,'374151',false,9,'left');}
  }
}

// Colore la colonne STATUT (dernière col) d'un sheet Base_Equipements
function colorStatusColumn(ws,rowCount,statColIdx){
  const statusColors={
    'Effectué':  {bg:'D1FAE5',fg:'065F46'}, // vert pâle
    'Planifié':  {bg:'DBEAFE',fg:'1E40AF'}, // bleu pâle
    'En retard': {bg:'FEE2E2',fg:'991B1B'}, // rouge pâle
    'Bientôt':   {bg:'FEF3C7',fg:'92400E'}, // orange pâle
  };
  for(let ri=0;ri<rowCount;ri++){
    const ref=XLSX.utils.encode_cell({r:ri+1,c:statColIdx});
    if(!ws[ref])continue;
    const val=String(ws[ref].v||'');
    const sc=statusColors[val];
    if(sc)ws[ref].s=S(sc.bg,sc.fg,true,9,'center');
  }
}
...
function downloadMachinePlanning(machineName){
  ...
  // ── Base_Equipements avec colonne STATUT colorée ──
  ...
  const wsInfo=lib.utils.aoa_to_sheet([infoH,...infoR]);
  wsInfo['!cols']=[{wch:22},{wch:38},{wch:24},{wch:14},{wch:18},{wch:14},{wch:14}];
  styleSimpleSheet(wsInfo,infoH.length,infoR.length);
  colorStatusColumn(wsInfo,infoR.length,6); // colonne STATUT = index 6
  lib.utils.book_append_sheet(wb,wsInfo,'Base_Equipements');

  // ── Plannings ──
  const graisses=machineTasks.filter(t=>t.type==='Graisse');
  const huiles  =machineTasks.filter(t=>t.type==='Huile');
  if(graisses.length)buildWeeklySheet(lib,wb,graisses,weeks,calYear,currentWeek,`Planning_Graissage_${calYear}`,'G');
  if(huiles.length)  buildWeeklySheet(lib,wb,huiles,  weeks,calYear,currentWeek,`Planning_Vidange_${calYear}`,  'V');
  ...
  const wsHist=lib.utils.aoa_to_sheet([histH,...histR]);
  wsHist['!cols']=[{wch:14},{wch:22},{wch:16},{wch:10},{wch:24},{wch:18},{wch:12}];
  styleSimpleSheet(wsHist,histH.length,histR.length);
  lib.utils.book_append_sheet(wb,wsHist,'Historique');

  const safeName=machineName.replace(/[/\\:*?"<>|]/g,'_');
  lib.writeFile(wb,`LubriPlan_${safeName}_${calYear}.xlsx`);
  toast(`📊 Planning "${machineName}" téléchargé`);
}

// ══════════════════════════════════════════════════════════
// buildWeeklySheet — feuille planning S1..S52 avec couleurs
// Couleurs identiques au planning web :
//   🟢 VERT  #22C55E = effectué
//   🔵 BLEU  #3B82F6 = planifié futur
//   🔴 ROUGE #EF4444 = en retard / semaine courante non faite
//   🟡 ORANGE #F59E0B = bientôt (semaine suivante)
// ══════════════════════════════════════════════════════════
function buildWeeklySheet(lib,wb,taskList,weeks,yr,currentWeek,sheetName,letter){
  if(!taskList.length)return;
  const now=new Date();
  const mwMap=buildMonthWeekMap(yr);
  const monthRanges=buildMonthRanges(yr);

  // Couleurs cellules planning (même palette que le web)
  function getCellColor(t,w){
    const isCurW=(w===currentWeek&&yr===now.getFullYear());
    const isPastW=(w<currentWeek&&yr===now.getFullYear());
    const isSoonW=!isPastW&&!isCurW&&yr===now.getFullYear()&&(w-currentWeek)<=1;
    if(t.done)            return{bg:'22C55E',fg:'FFFFFF'}; // vert
    if(isPastW||isCurW)   return{bg:'EF4444',fg:'FFFFFF'}; // rouge
    if(isSoonW)           return{bg:'F59E0B',fg:'FFFFFF'}; // orange
  ...
  // Ligne 0 — Mois (une cellule par 1ère semaine du mois, vide sinon)
  const moLabelAtCol={};
  monthRanges.forEach(mr=>{moLabelAtCol[mr.wStart]=MONTHS_S[mr.mo];for(let w=mr.wStart+1;w<=mr.wEnd;w++)moLabelAtCol[w]='';});
  ...
  machineOrder.forEach(mn=>{
    byMachine[mn].forEach((t,ti)=>{
      ...
      const sub=t.note?t.note.substring(0,55)+(t.note.length>55?'…':''):'';
      const row=[ti===0?mn:'',sub,t.prod||''];
      weeks.forEach(w=>row.push(aw.has(w)?letter:''));
      aoa.push(row);
      rowMeta.push({groupIdx,task:t,machineName:mn,activeWeeks:aw});
    });
    groupIdx++;
  });

  const ws=lib.utils.aoa_to_sheet(aoa);
  const totalRows=aoa.length,totalCols=3+52;
  const thin={style:'thin',color:{rgb:'E5E7EB'}};
  const tb={top:thin,bottom:thin,left:thin,right:thin};
  const tbThick={top:thin,bottom:thin,left:thin,right:{style:'medium',color:{rgb:'374151'}}};
  ...
  for(let ri=0;ri<totalRows;ri++){
    for(let ci=0;ci<totalCols;ci++){
      ...
      if(ri===0){
        // Ligne mois — bleu nuit, couleur légèrement différente par mois
        const moColors=['1E3A5F','1B4571','183D65','153459','112E50','1A3F68'];
        const w=ci-2;const mo=ci>=3?mwMap[w]:null;
        const moBg=mo!==undefined?moColors[mo%moColors.length]:'1E3A5F';
        ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:ci<3?'1E3A5F':moBg}},font:{bold:true,color:{rgb:'FFFFFF'},sz:ci<3?10:9,name:'Calibri'},alignment:{horizontal:'center',vertical:'center',wrapText:false},border:ci===2?tbThick:tb};

      }else if(ri===1){
        // Ligne semaines
        const wn=ci-2;const isCurW=(wn===currentWeek&&yr===now.getFullYear());
        let bgW=ci<3?'1E3A5F':(isCurW?'EF4444':'111827');
        ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:bgW}},font:{bold:true,color:{rgb:'FFFFFF'},sz:8,name:'Calibri'},alignment:{horizontal:'center',vertical:'center',wrapText:false},border:ci===2?tbThick:tb};
        ...
        if(ci===0){
          ...
          ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:hasN?'EFF6FF':rowBg}},font:{bold:hasN,color:{rgb:hasN?'1E3A5F':'6B7280'},sz:9,name:'Calibri'},alignment:{horizontal:'center',vertical:'center',wrapText:false},border:{top:thin,bottom:thin,left:thin,right:{style:'thin',color:{rgb:'BFDBFE'}}}};
        }else if(ci===1){
          ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:rowBg}},font:{sz:8,name:'Calibri',color:{rgb:'374151'}},alignment:{horizontal:'left',vertical:'center',wrapText:false},border:tb};
        }else if(ci===2){
          const hasL=cellVal&&String(cellVal).trim()!=='';
          ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:rowBg}},font:{bold:hasL,sz:8,name:'Calibri',color:{rgb:hasL?'1E40AF':'9CA3AF'}},alignment:{horizontal:'left',vertical:'center',wrapText:false},border:tbThick};
        }else{
          // Colonne semaine
          const wn=ci-2;
          const hasCell=(cellVal===letter);
          if(hasCell&&meta){
            const col=getCellColor(meta.task,wn);
            ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:col.bg}},font:{bold:true,color:{rgb:col.fg},sz:9,name:'Calibri'},alignment:{horizontal:'center',vertical:'center',wrapText:false},border:tb};
          }else{
            ws[ref].s={fill:{patternType:'solid',fgColor:{rgb:rowBg}},border:tb};
          }
        }
      }
    }
  ...
  ws['!cols']=[{wch:20},{wch:34},{wch:22},...Array(52).fill({wch:3.0})];
...
function downloadAllPlannings(){
  ...
  const wsRecap=lib.utils.aoa_to_sheet([recapH,...recapR]);
  wsRecap['!cols']=[{wch:22},{wch:18},{wch:12},{wch:10},{wch:25},{wch:14},{wch:18},{wch:14},{wch:14}];
  styleSimpleSheet(wsRecap,recapH.length,recapR.length);
  colorStatusColumn(wsRecap,recapR.length,8);
  lib.utils.book_append_sheet(wb,wsRecap,'Base_Equipements');
  const allG=tasks.filter(t=>t.type==='Graisse'),allH=tasks.filter(t=>t.type==='Huile');
  if(allG.length)buildWeeklySheet(lib,wb,allG,weeks,calYear,currentWeek,`Planning_Graissage_${calYear}`,'G');
  if(allH.length)buildWeeklySheet(lib,wb,allH,weeks,calYear,currentWeek,`Planning_Vidange_${calYear}`,'V');
...
function buildHistView(){
  ...
  const ti=all.length,tm=all.filter(({d})=>{const dt=new Date(d);return!isNaN(dt)&&dt.getMonth()===new Date().getMonth()&&dt.getFullYear()===new Date().getFullYear();}).length;
  const byType={Huile:all.filter(({t})=>t.type==='Huile').length,Graisse:all.filter(({t})=>t.type==='Graisse').length};
  const sb=`<div class="hist-stats-bar"><div class="hist-stat-item"><div class="hist-stat-val">${ti}</div><div class="hist-stat-lbl">Total interventions</div></div><div class="hist-stat-sep"></div><div class="hist-stat-item"><div class="hist-stat-val" style="color:var(--green)">${tm}</div><div class="hist-stat-lbl">Ce mois-ci</div></div><div class="hist-stat-sep"></div><div class="hist-stat-item"><div class="hist-stat-val" style="color:#3182CE">${byType.Huile}</div><div class="hist-stat-lbl">Vidanges huile</div></div><div class="hist-stat-sep"></div><div class="hist-stat-item"><div class="hist-stat-val" style="color:#D69E2E">${byType.Graisse}</div><div class="hist-stat-lbl">Graissages</div></div></div>`;
  ...
  return`${sb}<div class="tbl-wrap" style="margin-top:16px"><table style="width:100%;border-collapse:collapse"><thead><tr style="background:#1a365d"><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">DATE</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">ÉQUIPEMENT</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">TYPE</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">PRODUIT</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">FRÉQUENCE</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px;border-right:1px solid #2d4a7a">TECHNICIEN</th><th style="padding:12px 14px;text-align:left;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:0.5px">CRITICITÉ</th></tr></thead><tbody>${rows}</tbody></table></div>`;
}
...
function openDp(si){
  ...
  const hH=(t.hist||[]).filter(d=>d&&d!=='undefined'&&d!=='null'&&String(d).trim()!=='').length?(t.hist||[]).filter(d=>d&&d!=='undefined'&&d!=='null'&&String(d).trim()!=='').map(d=>`<div class="hist-entry">✓ Effectué le ${fmtD(d)}</div>`).join(''):'<div style="font-size:12px;color:var(--text3)">Aucune intervention</div>';
...
function exportXLSX(){
  ...
  const ws=lib.utils.aoa_to_sheet([header,...rows]);
  ws['!cols']=[5,25,12,10,25,10,14,18,12,20,10,30,10,20].map(w=>({wch:w}));
  styleSimpleSheet(ws,header.length,rows.length);
...
// ── IMPORT ──
function importFile(e){const file=e.target.files[0];if(!file)return;const ext=file.name.split('.').pop().toLowerCase();if(ext==='xlsx'||ext==='xls')importXLSX_file(file);else importCSVfile(file);e.target.value='';}
function importXLSX_file(file){
  ...
  reader.onload=function(ev){
    try{
      ...
      const header=rows[0].map(h=>String(h).toLowerCase().trim());let count=0;
      rows.slice(1).forEach(row=>{
        ...
        tasks.push({id:nextTaskId(),comp,crit,type,prod:get(['produit','référence','reference','réf','ref','lubrifiant']),qty:get(['quantité','quantite','qty']),freq,date,techId:null,dur:get(['durée','duree','dur']),loc:get(['localisation','local','emplacement','zone','lieu']),note:get(['remarque','note','commentaire']),done,hist:done?[date]:[]});
        count++;
      });
